...
class Main(BaseResourcePrint):
    ...
    def table_script_parameters_pane(self, pane,**kwargs):
       ...
       fb.div('Selezionando le date "dal" "al" otterremo il filtro sulle fatture ma per avere la situazione contabile alla data dobbiamo inserire la data nella view Date<=', font_weight='bold',style='margin-bottom:10px;text-align:left;')
